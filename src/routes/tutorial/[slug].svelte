...
<script>
  ...
  const loadDisqus = () => {
    ...
    s.src = 'https://kayaa-karya.disqus.com/embed.js';
...
<svelte:head>
  ...
  <link rel="fluid-icon" href={thumbnail} {title} />
...
{#if id}
  <section class="content" style="margin-top:20px">
    <div class="content-header">
      ...
      <span class="top-info estimasi"><i class="material-icons">access_time</i>
        estimasi
        {estimasi}</span>
...
{:else}
  <section class="content" style="margin-top:20px">
    <div class="content-header">
      <span class="top-info" />
      <span class="top-info estimasi"><i
...
<section id="comment" class="content">
